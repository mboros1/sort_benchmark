...
size_t insert_sorts = 0;
size_t unguarded_insertion_sorts = 0;
size_t partial_insertion_sorts = 0;
size_t sort2s = 0;
size_t sort3s = 0;
size_t partition_right_branchlesses = 0;
size_t partition_rights = 0;
size_t partition_lefts = 0;
size_t loops = 0;
...
int main() {
  ...
  for (int i = 0; i < 10; ++i) {
    std::vector<std::vector<int>> arrays(iterations,
    ...
    for (int i = 0; i < iterations; ++i) {
        pdqsort(arrays[i].begin(), arrays[i].end());
    }
  ...
  std::cout <<
"insert_sorts: " << insert_sorts << '\n'
<< "unguarded_insertion_sorts: " << unguarded_insertion_sorts << '\n'
<< "partial_insertion_sorts: " << partial_insertion_sorts << '\n'
<< "sort2s: " << sort2s << '\n'
<< "sort3s: " << sort3s << '\n'
<< "partition_right_branchlesses: " << partition_right_branchlesses << '\n'
<< "partition_rights: " << partition_rights << '\n'
<< "partition_lefts: " << partition_lefts << '\n'
<< "loops: " << loops << '\n';
